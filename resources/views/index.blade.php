        ...
        <div
            ...
            <div class="mt-3 mt-sm-0 ml-sm-3">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn btn-sm btn-alt-primary"
                        id="dropdown-analytics-overview" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
        ...
        <div class="col-xl-4 d-flex flex-column">
            ...
            <div class="row row-deck flex-grow-1">
                <div class="col-md-6 col-xl-12">
                    <div class="block block-rounded d-flex flex-column">
                        <div
                            class="block-content block-content-full flex-grow-1 d-flex justify-content-between">
                            <dl class="mb-0">
                        ...
                        <div class="block-content p-1 text-center overflow-hidden">
                            ...
                            <span class="js-sparkline" data-type="line"
                                ...
                                data-height="70px" data-chart-range-min="20"
                    ...
                    <div class="block block-rounded d-flex flex-column">
                        ...
                        <div class="block-content p-1 text-center oveflow-hidden">
                            ...
                            <span class="js-sparkline" data-type="line"
                                ...
                                data-height="70px" data-chart-range-min="0"
                                data-line-color="rgba(70,195,123, .4)"
                                data-fill-color="rgba(70,195,123, .15)" data-spot-color="transparent"
                                data-min-spot-color="transparent" data-max-spot-color="transparent"
                                data-highlight-spot-color="#46C37B" data-highlight-line-color="#46C37B"
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn btn-sm btn-alt-primary"
                        id="dropdown-recent-orders-filters" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                ...
                <table class="table table-borderless table-striped table-vcenter">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">27 min ago
                            </td>
                            ...
                            <td>
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded  bg-danger-light text-danger">Canceled</span>
                            </td>
                            ...
                            <td class="d-none d-sm-table-cell text-center">
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">3%</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">8 min ago
                            </td>
                            <td class="d-none d-xl-table-cell font-size-sm">
                            ...
                            <td>
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded  bg-success-light text-success">Delivered</span>
                            </td>
                            <td class="d-none d-xl-table-cell text-center font-size-sm">
                            ...
                            <td class="d-none d-sm-table-cell text-center">
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">17%</span>
                            </td>
                            <td class="d-none d-sm-table-cell text-right font-size-sm">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">6 min ago
                            </td>
                            <td class="d-none d-xl-table-cell font-size-sm">
                            ...
                            <td>
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded  bg-warning-light text-warning">Processing</span>
                            </td>
                            <td class="d-none d-xl-table-cell text-center font-size-sm">
                            ...
                            <td class="d-none d-sm-table-cell text-center">
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">25%</span>
                            </td>
                            <td class="d-none d-sm-table-cell text-right font-size-sm">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">19 min ago
                            </td>
                            <td class="d-none d-xl-table-cell font-size-sm">
                            ...
                            <td class="d-none d-sm-table-cell text-center">
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">12%</span>
                            </td>
                            <td class="d-none d-sm-table-cell text-right font-size-sm">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">11 min ago
                            </td>
                            <td class="d-none d-xl-table-cell font-size-sm">
                            ...
                            <td class="d-none d-sm-table-cell text-center">
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">14%</span>
                            </td>
                            <td class="d-none d-sm-table-cell text-right font-size-sm">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">2 min ago
                            </td>
                            <td class="d-none d-xl-table-cell font-size-sm">
                            ...
                            <td class="d-none d-sm-table-cell text-center">
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">7%</span>
                            </td>
                            <td class="d-none d-sm-table-cell text-right font-size-sm">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">3 min ago
                            </td>
                            <td class="d-none d-xl-table-cell font-size-sm">
                            ...
                            <td class="d-none d-sm-table-cell text-center">
                                <span
                                    class="font-size-sm font-w600 px-2 py-1 rounded bg-body-dark">23%</span>
                            </td>
                            <td class="d-none d-sm-table-cell text-right font-size-sm">
                                <strong>$96,40</strong>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">13 min ago
                            </td>
                            <td class="d-none d-xl-table-cell font-size-sm">
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell font-size-sm font-w600 text-muted">9 min ago
                            </td>
                            <td class="d-none d-xl-table-cell font-size-sm">
                                <a class="font-w600" href="javascript:void(0)">Amanda Powell</a>
                            </td>
